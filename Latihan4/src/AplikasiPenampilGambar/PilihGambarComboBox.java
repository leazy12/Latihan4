...
public class PilihGambarComboBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pCardLayout.add(lblIg, "3");

        pilihan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Select -", "Whatsapp", "Twitter", "Instagram" }));
